...
gym.register(
    id="Isaac-PickPlace-A2-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pickplace_a2_env_cfg:PickPlaceA2EnvCfg",
        "robomimic_bc_cfg_entry_point": f"{agents.__name__}:robomimic/bc_rnn_low_dim.json",
    },
    disable_env_checker=True,
)
...
gym.register(
    id="Isaac-PickPlace-A2-Mimic-v0",
    entry_point="isaaclab_mimic.envs.pinocchio_envs.pickplace_a2_mimic_env:PickPlaceA2MimicEnv",
    kwargs={
        "env_cfg_entry_point": (
            "isaaclab_mimic.envs.pinocchio_envs.pickplace_a2_mimic_env_cfg:PickPlaceA2MimicEnvCfg"
        ),
    },
    disable_env_checker=True,
)
...
gym.register(
    id="Isaac-PickPlace-A2OmniHand-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pickplace_a2_omnihand_env_cfg:PickPlaceA2OmniHandEnvCfg",
        "robomimic_bc_cfg_entry_point": f"{agents.__name__}:robomimic/bc_rnn_low_dim.json",
    },
    disable_env_checker=True,
)
...
gym.register(
    id="Isaac-PickPlace-X2-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pickplace_x2_env_cfg:PickPlaceX2EnvCfg",
        "robomimic_bc_cfg_entry_point": f"{agents.__name__}:robomimic/bc_rnn_low_dim.json",
    },
    disable_env_checker=True,
)
...
gym.register(
    id="Isaac-PickPlace-X2-Grasper-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pickplace_x2_grasper_env_cfg:PickPlaceX2GrasperEnvCfg",
        "robomimic_bc_cfg_entry_point": f"{agents.__name__}:robomimic/bc_rnn_low_dim.json",
    },
    disable_env_checker=True,
)
